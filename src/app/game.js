...
import { DIRECTIONS, MAP, TILE, GRAVITY, MAXDX, MAXDY, ACCEL, FRICTION, IMPULSE, DIAMOND_COLORS, KEY, fps, step, canvas, ctx, width, height, assets, font } from './constants';
import {  life } from './main';
